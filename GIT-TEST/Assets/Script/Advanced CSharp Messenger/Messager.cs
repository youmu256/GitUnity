...
#pragma warning disable 0414
    static private MessagerHelper messagerHelper = (new GameObject("MessagerHelper")).AddComponent<MessagerHelper>();
...
#region Helper methods
    ...
    static public void MarkAsPermanent(string eventType) {
        #if LOG_ALL_MESSAGES
            Debug.Log("Messager MarkAsPermanent \t\""+eventType+"\"");
        #endif
    ...
    static public void PrintEventTable() {
        Debug.Log("\t\t\t===MESSAGER PrintEventTable===");
        foreach (KeyValuePair<string, Delegate> pair in eventTable) {
...
public sealed class MessagerHelper : MonoBehaviour {
        void Awake() {
